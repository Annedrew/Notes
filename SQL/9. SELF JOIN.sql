...
WHERE r.num IN (SELECT num FROM route WHERE stop = (SELECT id FROM stops WHERE name = 'Craiglockhart') AND company = 'LRT')
AND r.company = 'LRT';
...
FROM route r1
JOIN route r2 ON r1.company = r2.company AND r1.num = r2.num
JOIN stops s2 ON r2.stop = as2.id
...
ORDER BY r1.company, r1.num, r3.company, r3.num;
